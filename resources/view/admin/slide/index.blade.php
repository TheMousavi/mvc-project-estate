                                ...
                                <div class="">
                                    <table class="table zero-configuration">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $slide->address ?></td>
                                            <td><?= $slide->amount ?></td>
                                            <td><img style="width: 90px;" src="<?= asset($slide->image) ?>" alt="avatar"></td>
                                            <td style="min-width: 16rem; text-align: left;">
                                                <a href="<?= route('admin.slide.edit' , ['id' => $slide->id]) ?>" class="btn btn-info waves-effect waves-light">ویرایش</a>
