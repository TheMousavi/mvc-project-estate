                                    ...
                                    <table class="table zero-configuration">
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td style="width: 22rem;">
                                                <a href="<?= route('admin.ads.gallery' , ['id' => $advertise->id]) ?>" class="btn btn-warning waves-effect waves-light">گالری</a>
                                                <a href="<?= route('admin.ads.edit' , ['id' => $advertise->id]) ?>" class="btn btn-info waves-effect waves-light">ویرایش</a>
