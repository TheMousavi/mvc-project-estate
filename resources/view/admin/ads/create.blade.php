                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="toilet" class="select2 form-control <?= errorClass('toilet') ?>">
                                                    <option value="0" <?= old('toilet') == 0 ? 'selected' : '' ?>>ایرانی</option>
                                                    <option value="1" <?= old('toilet') == 1 ? 'selected' : '' ?>>فرنگی</option>
                                                    <option value="2" <?= old('toilet') == 2 ? 'selected' : '' ?>>ایرانی و فرنگی</option>
                                                </select>
                                                <?= errorText('toilet') ?>
                                            </div>
                                        </fieldset>
