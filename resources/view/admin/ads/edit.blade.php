...
@section('head-tag')
    <title>ادمین | ویرایش آگهی جدید</title>
@endsection
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="row" action="<?= route('admin.ads.update' , ['id' => $advertise->id]) ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <img src="<?= oldOrValue('image' , $advertise->image) ?>" alt="" , width="200" , height="150" class="mt-4">
                                            <?= errorText('image')?>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <section class="form-group">
                                            ...
                                            <textarea class="form-control <?= errorClass('description') ?>" id="description" rows="5" name="description" placeholder="متن ...">
                                                <?= oldOrValue('description' , $advertise->description) ?>
                                            </textarea>
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="toilet" class="select2 form-control <?= errorClass('toilet')?>">
                                                    <option value="0" <?= oldOrValue('toilet' , $advertise->toilet) == 0 ? 'selected' : '' ?>>ایرانی</option>
                                                    <option value="1" <?= oldOrValue('toilet' , $advertise->toilet) == 1 ? 'selected' : '' ?>>فرنگی</option>
                                                    <option value="2" <?= oldOrValue('toilet' , $advertise->toilet) == 2 ? 'selected' : '' ?>>ایرانی و فرنگی</option>
                                                </select>
                                                <?= errorText('toilet')?>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select name="sell_status" class="select2 form-control <?= errorClass('sell_status')?>">
                                                    ...
                                                    <option value="1"  <?= oldOrValue('sell_status' , $advertise->sell_status) == 1 ? 'selected' : '' ?>>اجاره</option>
                                                </select>
