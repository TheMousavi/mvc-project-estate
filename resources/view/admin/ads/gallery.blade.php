                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                ...
                                <form class="row" action="<?= route('admin.ads.store.gallery.image' , ['id' => $advertise->id]) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 mt-4 pt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-center">
                                            <div><img style="width: 90px;" src="<?= asset($gallery->image) ?>" alt=""></div>
