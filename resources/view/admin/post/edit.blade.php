                     ...
                     <form class="row" action="<?= route('admin.post.update' , ['id' => $post->id]) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                           <fieldset class="form-group">
                              ...
                              <input value="#" name="image" type="file" id="image" class="form-control-file <?= errorClass('image')?>">
                              <img src="<?= oldOrValue('image' , $post->image) ?>" alt="" , width="200" , height="150" class="mt-4">
                              <?= errorText('image')?>
                           </fieldset>
                        </div>
                        <div class="col-md-6">
                           <fieldset class="form-group">
                              <div class="form-group">
                                 ...
                                 <select name="cat_id" class="select2 form-control <?= errorClass('cat_id')?>">
                                    ...
                                    <option value="<?= $categorySelect->id ?>" <?= oldOrValue('cat_id' , $post->cat_id) === $categorySelect->id ? 'selected' : '' ?>>
                                        <?= $categorySelect->name ?>
                                    </option>
                                    <?php  } ?>
                                 </select>
