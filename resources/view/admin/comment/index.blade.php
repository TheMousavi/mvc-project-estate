                            ...
                            <div class="">
                                <table class="table zero-configuration">
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?=  $comment->approved == 0 ? '<span class="text-danger">در انتظار تایید</span>' :
                                                '<span class="text-success">تایید شده</span>' ?></td>
                                        ...
                                        <td>
                                         ...
                                         <?php  if ($comment->approved == 0) { ?>
                                            <a href="<?= route('admin.comment.approved' , [$comment->id]) ?>" class="btn btn-danger waves-effect waves-light">تایید</a>
                                            <?php } else { ?>
