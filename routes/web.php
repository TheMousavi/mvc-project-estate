...
Route::get('/admin/comment/show/{id}' , 'Admin\CommentController@create' , 'admin.comment.show');
Route::post('/admin/comment/approved/{id}' , 'Admin\CommentController@approved' , 'admin.comment.approved');
